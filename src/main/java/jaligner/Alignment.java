...
public final class Alignment {
	...
	/**
	 * Returns that length of the gap in the start of the alignment.
	 * If no such gap exists it returns 0
	 * @return length of the start gap
	 */
	...
	/**
	 * Returns that length of the gap in the end of the alignment.
	 * If no such gap exists it returns 0
	 *
	 * @return length of the end gap
	 */
	public int getEndGaps() {
		int count = 0;
		for (int i = markupLine.length - 1; i >= 0; i--) {
			if (markupLine[i] == Markups.GAP) {
				count++;
			} else {
				break;
	...
	/**
	 * Returns that total length of the gaps in the start and end of the alignment.
	 * If no such gaps exists it returns 0
	 *
	 * @return length of the terminal gaps
	 */
	public int getTerminalGaps() {
		return getStartGaps() + getEndGaps();
	}
