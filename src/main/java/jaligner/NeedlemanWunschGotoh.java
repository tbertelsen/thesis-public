...
public final class NeedlemanWunschGotoh {
    ...
    private static Alignment traceback(Sequence s1, Sequence s2, Matrix m,
        ...
        while (stillGoing) {
            rounds++;
            if (rounds > reversed1.length * 2) {
                throw new IllegalStateException("Could not trace back alignment. Too many rounds: " + rounds +
                        "\nGene 1: " + s1 + "\nGene 2: " + s2);
            }
            int l = row + j;
            switch (pointers[l]) {
            ...
            case Directions.STOP:
                ...
                break;
            default:
                throw new IllegalStateException("Could not trace back alignment. Found direction: " + pointers[l] +
                        "\nGene 1: " + s1 + "\nGene 2: " + s2);
